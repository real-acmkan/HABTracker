...
exports.createSightsContent = void 0;
const append_stars_rating_1 = require("./append-stars-rating");
const easings_1 = require("./easings");
const createSightsContent = (data, basemap, initialCamera) => {
    ...
    data.map((attraction) => {
        ...
        if (place && place.name && place.formatted_address) {
            ...
            if (place.rating) {
                ...
                append_stars_rating_1.default(stars, place.rating);
            ...
            if (place.user_ratings_total) {
                reviews.innerText = `${new Intl.NumberFormat().format(place.user_ratings_total)} reviews`;
            }
            ...
            sightItem.onclick = () => {
                ...
                if (Math.abs(currCenter.lat() - newCenter.lat) < maxOffsetCenterError &&
                ...
                basemap.animateToLinear(toCamera, 1000, easings_1.easeInOutCubic);
            };
...
exports.createSightsContent = createSightsContent;
