...
const hotels_ui_green_marker_svg_1 = require("url:../../public/images/hotels-ui-green-marker.svg");
// we will render static pages content to the dom
// and prepare dom nodes for later requests with places api
const createHotels = (pageContent, travelDetails) => {
    ...
    addressMarker.src = hotels_ui_green_marker_svg_1.default;
